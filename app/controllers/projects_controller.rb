class ProjectsController < ApplicationController
  ...
  def users
    ...
    @other_users = @tenant.users.where(is_admin: false) - (@project.users + [current_user])
  end
  ...
  private
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant_id.to_s
        redirect_to :root, flasj: {error: 'You are not authorized to access any organization other than your own'}
      end
    end
end
